...
function StatsDash() {
  ...
  return (
    <motion.div
      className={cn(
        "relative mt-14 flex h-full flex-col gap-3",
        `md:h-[calc(100vh-114px)]`,
        "md:grid md:grid-rows-[1fr_1fr]",
        `l:grid-cols-[5fr_2fr] l:grid-rows-1 l:gap-2`,
        "[@media(min-width:1024px)_and_(min-height:1366px)]:grid-rows-[1fr_1fr]",
        "[@media(min-width:1024px)_and_(min-height:1366px)]:grid-cols-1",
        "3xl:max-h-[calc(1000px-100px)] 2xl:mt-16"
      )}
    >
      {/* <div className="h-full bg-lime-500">fadf</div>
      <div className="h-full bg-lime-500">fadf</div> */}
      <div
        className={cn(
          "[@media(min-width:1024px)_and_(min-height:1366px)]:h-full",
