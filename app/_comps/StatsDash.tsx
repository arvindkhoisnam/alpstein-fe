...
function StatsDash() {
  ...
  return (
    ...
    >
      <div className="l:grid-rows-[1fr_2fr] l:grid-cols-1 l:gap-3 l:max-h-[calc(100vh-114px)] flex w-full flex-col gap-3 bg-rose-500 md:grid md:max-h-[calc(100vh-56px)] md:grid-cols-[1fr_2.5fr] 2xl:max-h-[calc(100vh-100px)]">
        <PopularCoins />
      ...
      <div className="l:grid-cols-1 l:grid-rows-[1.5fr_1fr] l:max-h-[calc(100vh-114px)] grid grid-rows-[1.5fr_1fr] gap-2 bg-rose-500 md:max-h-[calc(100vh-56px)] md:grid-cols-[2fr_1fr] md:grid-rows-1 2xl:max-h-[calc(100vh-100px)]">
        <Performers />
        <PremiumCard />
      </div>
    </motion.div>
