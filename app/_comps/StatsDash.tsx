...
function StatsDash() {
  return (
    <motion.div
      className={cn(
        "l:grid-cols-[5fr_2fr] l:grid-rows-1 l:gap-3 l:mb-0 3xl:max-h-[calc(1000px-100px)] relative mt-14 mb-14 flex h-full flex-col gap-3 md:grid md:max-h-[calc(100vh-56px)] md:grid-rows-[1.5fr_1fr] md:gap-3 2xl:mt-16 2xl:max-h-[calc(100vh-100px)]"
      )}
    >
