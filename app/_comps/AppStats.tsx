...
function AppStats() {
  return (
    <div className="flex h-full w-full gap-3 md:grid md:grid-cols-2 md:gap-2">
...
function Comp1({ label, graph }: { label: string; graph: React.ReactElement }) {
  return (
    <div
      className={cn(
        "flex h-52 w-72 flex-col gap-5 rounded-2xl p-2 md:h-64 md:max-w-full md:min-w-full lg:h-full",
        "relative",
