...
function AppStats() {
  return (
    <div className="flex h-full w-full gap-3 overflow-x-scroll md:grid md:grid-cols-2 md:gap-2 lg:gap-2">
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "l:h-50 l2:h-52 md2:h-86 flex h-52 w-72 flex-col gap-5 rounded-2xl p-2 md:h-72 md:max-w-full md:min-w-full lg:h-65",
        "relative",
