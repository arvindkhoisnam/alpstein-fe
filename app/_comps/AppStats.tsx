...
function AppStats() {
  return (
    <div className="flex max-h-full max-w-full gap-3 overflow-x-scroll md:grid md:grid-cols-2 md:gap-2 lg:gap-2">
...
function Comp1({ label, graph }: { label: string; graph: React.ReactElement }) {
  return (
    <div
      ...
      className={cn(
        "l:h-50 l2:h-56 md2:h-86 flex h-52 w-72 flex-col gap-5 rounded-2xl p-2 md:h-72 md:max-w-full md:min-w-full lg:h-67",
        "relative",
